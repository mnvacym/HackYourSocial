    ...
    <Fragment>
      {isPasswordReset ? (
        ...
        <div className="row justify-content-center">
          <div className="col-10 col-sm-7 col-md-5 col-lg-4">
            <p>
              If you want to reset your password, please enter your email here and a link will be
              sent to your email address to reset the password.
            </p>
...
//             to your email address to reset the password.
//           </p>
